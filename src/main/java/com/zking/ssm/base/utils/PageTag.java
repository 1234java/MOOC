package com.zking.ssm.base.utils;
...
public class PageTag extends BodyTagSupport {
	...
	private String toHtml() {
		...
		// 2. 生成按钮
		bf.append("<div class='pager' >共"+ pageBean.getTotal() + "条记录&nbsp; 每页"+pageBean.getRows() + "条,当前第" + pageBean.getPage() + "页，共" + pageBean.getMaxPage()
				...
				+ pageBean.getMaxPage()
				+ ")'>尾&nbsp;页</a>&nbsp;跳转到<input id='pageNumber' type='text' style='text-align: center;width: 30px;'>页&nbsp;<a href='javascript:doSkipPage();'>GO</a>&nbsp;&nbsp;</div>");
