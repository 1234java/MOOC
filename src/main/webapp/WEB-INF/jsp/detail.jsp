...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /> 
	<title>detail</title>
<link rel="stylesheet" type="text/css" href="${ctx}/css/stylehd.css">
	  ...
	  <div class="zxcf_detail px1000">
	  	     <div class="detail_intro clearfix">
	  	     	    	  ...
	  	     	    	  <div class="det_intro_text mr20">
                                    ...
                                    <li>
	  	     	    	  	    ...
	  	     	    	  	    <ul class="det_intro_tul2 clearfix">
	  	     	    	  	    	<li>
	  	     	    	  	    		发布日期：<%= new Date().toLocaleString()%>
	  	     	    	  	    	</li>
	  	     	    	  	    	<li>
	  	     	    	  	    	    还款方式：${s}
	  	     	    	  	    	</li>
	  	     	    	  	    	<li>
	  	     	    	  	    		 还款日期：${b.bMoneyDeadline}
	  	     	    	  	    	</li>
	  	     	    	  	    	<li>
	  	     	    	  	    		保障机构：北京国能小额贷款股份公司
	  	     	    	  	    	</li>
	  	     	    ...
	  	     	    <div class="detail_intro_r fr">
                          ...
                          <!--  -->
                          <p class="det_rzye clearfix"><span class="fl">融资余额</span><em class="fr"><strong>${c}</strong>元</em></p>


						  <form action="${ctx}/zking/index?bid=${b.bId}&btype=${b.bBorrowerType}" method="post">
                          <p class="det_input">
                          	  <input type="text" placeholder="100" name="iMoney">
                          </p>
                          <p class="det_shouyi">每投资1万元收益<strong>1700元</strong></p>
							  <p><button type="submit" value="立即投资" class=" pro_btn det_btn">立即投资</button></p>
                          <%--<p><a href="${ctx}/zking/index?bid=${b.bId}" class=" pro_btn det_btn">立即投资</a></p>--%>
						  </form>
	  	     	    </div>
	  	     </div>
	  	     <!-- end block1 -->
