...
<div class="invest_con_wper">
	  <div class="invest_con px1000">
		  ...
		  <%--<c:forEach var="v" items="${b}">${v}</c:forEach>--%>
		  <div class="product_list mt20">
			  <c:forEach var="v" items="${ls}" varStatus="loop">
				  <%--${i}--%>
	  	    	     <div class="prolist_one prolist_one_bl01 mt20">
                           ...
                           <ul class="prolist_one_ul clearfix">
                           	   <li>
                           	   	   年华收益：<strong>${v.bRate}%</strong><br>
								   还款方式：${v.borrowerTyper.bTypeName}
                           	   </li>
                           	   <li>
								   剩余期限：<i>${sa[loop.count-1].bMoth}</i>天<br>
                                    保障机构：中融兴业融资担保有限公司
                           	   </li>
                           	   <li class="prolist_press">
                           	   	   募集金额：<strong>${sa[loop.count-1].bSum}</strong> 元 <br>
                                   认购进度：<span class="ui-progressbar-mid ui-progressbar-mid-100">100%</span>
                           	   </li>
                           	   <li class="prolist_btn">
                           	   	    <a href="${ctx}/zking/detail?bid=${v.bId}" class="pro_btn">立即投资</a>
                           	   </li>
                           </ul>
	  	             </div>
			  </c:forEach>
